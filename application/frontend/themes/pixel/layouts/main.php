...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body class="theme-fresh main-menu-animated main-navbar-fixed main-menu-fixed">
        <?php $this->beginBody() ?>
                ...
                <div class="navbar-inner">
                    ...
                    <div class="navbar-header">
                        ...
                        <a href="<?php echo \yii\helpers\Url::home(); ?>" class="navbar-brand">
                            <div><img alt="Pixel Admin" src="<?php echo \yii\helpers\Url::to(['@web/themes/pixel/assets/demo/logo-big.png']); ?>"></div>
